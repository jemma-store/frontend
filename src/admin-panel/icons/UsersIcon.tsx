export default function UsersIcon() {
  return (
    ...
    >
      <path
        d="M18.8419 7.875C18.7046 9.78141 17.2903 11.25 15.7482 11.25C14.206 11.25 12.7894 9.78188 12.6544 7.875C12.5138 5.89172 13.8905 4.5 15.7482 4.5C17.6058 4.5 18.9825 5.92781 18.8419 7.875Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
